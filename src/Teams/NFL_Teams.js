...
const SOS2024 = [0.488, 0.453, 0.536, 0.516, 0.467, 0.467, 0.502, 0.547, 0.505, 0.495, 0.509, 0.526, 0.526, 0.491, 0.512, 0.502, 0.512, 0.478, 0.505, 0.488, 0.502, 0.512, 0.453, 0.516, 0.505, 0.491, 0.533, 0.488, 0.505, 0.478, 0.491, 0.502];
const SOS2025 = [0.457, 0.478, 0.533, 0.467, 0.457, 0.571, 0.509, 0.519, 0.557, 0.506, 0.571, 0.557, 0.481, 0.464, 0.467, 0.522, 0.502, 0.522, 0.491, 0.474, 0.557, 0.429, 0.419, 0.574, 0.460, 0.561, 0.526, 0.474, 0.415, 0.481, 0.450, 0.550];
const SOS2026 = [0.538, 0.465, 0.479, 0.528, 0.521, 0.550, 0.450, 0.429, 0.493, 0.512, 0.467, 0.538, 0.474, 0.465, 0.490, 0.536, 0.529, 0.522, 0.516, 0.542, 0.519, 0.531, 0.434, 0.498, 0.517, 0.481, 0.495, 0.514, 0.497, 0.491, 0.476, 0.502];
...
const Teams = (season) => {
    ...
    if (season in SOSMAP) {
        ...
        console.error("No defined SOS for selected season");
        return [];
    }
